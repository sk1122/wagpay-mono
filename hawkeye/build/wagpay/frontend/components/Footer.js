    ...
    social: [
        {
            ...
            style: 'h-8 w-8 -mr-2',
            icon: (props) => (<svg fill="currentColor" {...props} viewBox="0 0 24 24">
...
const Footer = (props) => {
    return (<footer className="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              {footerNavigation.social.map((item) => (<a key={item.name} href={item.href} className={item.style + " text-gray-400 hover:text-gray-500"}>
