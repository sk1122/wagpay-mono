...
function create(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let { user, error: userErrors } = yield supabase_1.supabase.auth.api.getUser(req.headers['bearer-token']);
        ...
        if (req.method === 'GET') {
            const { data, error } = yield supabase_1.supabase.rpc('get_total_visits', {
